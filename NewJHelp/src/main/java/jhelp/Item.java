 ...
 * are defined in {@link JHelp} interface.
...
public class Item implements Serializable {
    ...
    /**
     * Record's number (primary key) in original database. Default value is 0.
     */
    private int id;
    /**
     * String object presents any data. Default values is {@link
     * JHelp#DEFAULT_KEY} or {@link JHelp#DEFAULT_VALUE}.
     * </code>
     */
    private String item;
    /**
     * Current state of item. All possible values are defined in
     * {@link JHelp} interface. Default values is <code>jhelp.JHelp.ORIGIN
     * </code>
     */
    private int state;
    ...
    /**
     * Method returns current item's value as {@link String} object.
     * @return current item's value. Method return {@link JHelp#DEFAULT_VALUE}
     * or {@link JHelp#DEFAULT_KEY} if item not set or unknown.
     * @see JHelp
     */
     ...
     * {@link JHelp} interface. Default value is {@link JHelp#ORIGIN}.
     * @see JHelp
     */
    public int getState() {
        return state;
     ...
     * @param item {@link String} object defines new value of
     ...
     * for this attribute are defined in {@link JHelp} interface.
